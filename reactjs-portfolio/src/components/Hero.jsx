...
export default function Hero({ primary, secondary }) {
  return (
    <div
      id="hero"
      className=" flex items-center justify-center mt-48 mb-32 gap-10"
    >
      <Fade>
        <div className="text-center">
          <h2 className="font-mono text-dark text-lg">Hi! I&apos;m Mark!</h2>
          <h2
            style={{ color: primary }}
            className="font-extrabold text-4xl md:text-5xl lg:text-6xl mb-3 text-dark"
          >
          ...
          <button className="outline outline-1 rounded text-dark py-1 px-5 hover:opacity-50 duration-200 ease-in-out font-mono my-5 mr-4">
            <Link
              to="contact"
              spy={true}
              smooth={true}
          ...
          <button className="font-mono outline  outline-1 rounded text-blue py-1 px-5 hover:bg-blue hover:bg-opacity-20 duration-200 ease-out my mr-4 md:hidden lg:hidden">
            CV
          </button>
        </div>
        ...
        <div className="absolute -z-10 ">
          <svg
            ...
            className="w-screen drop-shadow-lg opacity-10"
          >
            <path
              ...
              style={{ fill: primary, strokeWidth: "0px" }}
            />
            <g>
              <path
                d="M436.4,494.74h0c.76,5.15,1.16,10.43,1.16,15.81,0,6.4-.57,12.66-1.64,18.73h406.19s0,0,0,0c-1.07-6.07-1.64-12.33-1.64-18.74,0-5.38.4-10.66,1.16-15.81,0,0,0,0,0,0h-405.24Z"
                style={{ fill: secondary, strokeWidth: "0px" }}
              />
              <path
