...
const About = () => {
  return (
    <div id="about" className="py-48 px-4 sm:px-0 md:px-0 lg:px-36">
      ...
      <p className="text-grey text-justify">
        ...
        <span className="text-blue"> web development</span>. I started learning
        the basics on HTML, CSS and JavaScript, using free material on the
        internet: The Odin Project, FreeCodeCamp many youtube videos and various
        courses.
        <br />
        <br />
        Thanks to TheOdinProject i've come to understand foreign concepts to me
        such as the terminal, Git and{" "}
        <a href="https://github.com/emkeiboii" target="_blank">
          <span id="github" className="text-blue underline hover:opacity-80">
            GitHub
          </span>
        </a>
        <br />
